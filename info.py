...
# PyroClient Setup 
API_ID = int(environ['27653677'])
API_HASH = environ['5e92b41db6396a9a4415380ac9b4efca']
BOT_TOKEN = environ['6818372184:AAFpa2nMWSosHOHn-i_kTbi8TC2-TdXzzps']
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://anandrajsiddhartha2003:<password>@cluster0.pdalece.mongodb.net/?retryWrites=true&w=majority")
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/dec37102db11e67caabcb.jpg")
...
SHORT_API = environ.get("7c1729970ab224993fa24cd44d3e525952eda345")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/files_4uu')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002106264622')).split()]
